...
from policyengine.utils.reforms import apply_reform, use_current_parameters

warnings.filterwarnings("ignore")

baseline_system = apply_reform(
    use_current_parameters(), CountryTaxBenefitSystem()
)
baseline_parameters = baseline_system.parameters
