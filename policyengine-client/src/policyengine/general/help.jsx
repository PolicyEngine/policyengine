        ...
        <Modal visible={helpPaneOpen} centered closable={false} footer={null} width="50%">
            ...
            <div style={{ marginTop: 25 }}>
                ...
                {currentPane === 1 && <>
                    ...
                    <h6>Create your reform to taxes and benefits by dragging the sliders or manually entering values (your changes will save as you make them). When you're done, click <i>Compute your net income</i> to see how it'd affect your finances.</h6>
                    <div style={{ marginTop: 20 }} className="d-flex justify-content-center"><Button type="primary" onClick={() => setHelpPaneOpen(false)}>Let me jump in!</Button></div>
                </>}
            </div>
        </Modal>
