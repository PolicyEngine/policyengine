		...
		this.setState({waiting: true}, () => {
			fetch(url)
				.then((res) => {
					...
					this.context.updatePolicy("working_age_bi", this.context.policy["working_age_bi"].value + amount);
					this.context.updatePolicy("senior_bi", this.context.policy["senior_bi"].value + amount);
				}).catch(e => {
